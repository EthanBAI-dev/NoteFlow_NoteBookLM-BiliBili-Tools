...
const zh = {
  ...
  'more.bilibiliTimestampTitle': '哔哩哔哩字幕移除时间戳',
  'more.bilibiliTimestampDesc': '导出或导入哔哩哔哩字幕时，自动过滤 SRT 时间戳标记，仅保留纯文本内容',
  'more.saving': '保存中...',
  'more.saved': '已保存',
...
const en: Record<keyof typeof zh, string> = {
  ...
  'more.bilibiliTimestampTitle': 'Bilibili: remove timestamps',
  'more.bilibiliTimestampDesc': 'Strip SRT timestamp markers from Bilibili subtitle output, keeping only clean text',
  'more.saving': 'Saving...',
  'more.saved': 'Saved',
