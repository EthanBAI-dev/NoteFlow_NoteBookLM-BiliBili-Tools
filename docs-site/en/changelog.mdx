...
- 🎬 **Bilibili subtitle import**: Extract Bilibili video subtitles with 3 output modes (per-video, merged, ZIP download)
...
- 🔐 **Supabase auth**: Email registration and Google OAuth sign-in support
